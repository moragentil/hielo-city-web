    ...
    <section id="servicios" className="py-20 relative overflow-hidden justify-center flex">
      ...
      <div className="container relative z-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="bg-white/10 backdrop-blur-md p-8 rounded-xl border border-white/20 shadow-xl shadow-blue-900/20 relative overflow-hidden group transition-all duration-300 hover:-translate-y-1 flex flex-col h-full justify-between">
            <div>
          ...
          <div className="bg-white/10 backdrop-blur-md p-8 rounded-xl border border-white/20 shadow-xl shadow-blue-900/20 relative overflow-hidden group transition-all duration-300 hover:-translate-y-1 flex flex-col h-full justify-between">
            ...
            <a
              href="https://wa.me/5492214638936?text=Hola!%20Quisiera%20solicitar%20un%20plan%20para%20negocios."
              target="_blank"
              rel="noopener noreferrer"
              className="mt-8 w-full bg-white text-blue-700 hover:bg-white/90 shadow-lg shadow-blue-900/20 transition-all duration-300 hover:scale-105 rounded-md py-2 font-medium relative overflow-hidden group text-center"
            >
